...
def word_to_main_diag_down(grid, start_i, start_j, SEARCHED_WORD=SEARCHED_WORD):
    if start_j + len(SEARCHED_WORD) > len(grid[start_i]):
        return False
    if start_i + len(SEARCHED_WORD) > len(grid):
        return False
...
def word_to_main_diag_up(grid, start_i, start_j, SEARCHED_WORD=SEARCHED_WORD):
...
def word_to_sec_diag_up(grid, start_i, start_j, SEARCHED=SEARCHED_WORD):
    if SEARCHED == SEARCHED_WORD:
        return word_to_sec_diag_down(grid, start_i, start_j, REVERSED_WORD)
    else:
        return word_to_sec_diag_down(grid, start_i, start_j, SEARCHED_WORD)
"""
...
with open(sys.argv[1]) as file:
    ...
    while i < len(letter_grid):
        ...
        while j < len(letter_grid[i]):
            if j + 2 < len(letter_grid[i]) and word_to_main_diag_down(letter_grid, i, j) and word_to_sec_diag_down(letter_grid, i, j + 2):
                number_of_apperances += 1
            if j + 2 < len(letter_grid[i]) and word_to_main_diag_down(letter_grid, i, j) and word_to_sec_diag_up(letter_grid, i, j + 2):
                number_of_apperances += 1
            if j + 2 < len(letter_grid[i]) and word_to_main_diag_down(letter_grid, i, j, REVERSED_WORD) and word_to_sec_diag_down(letter_grid, i, j + 2, REVERSED_WORD):
                number_of_apperances += 1
            if j + 2 < len(letter_grid[i]) and word_to_main_diag_down(letter_grid, i, j, REVERSED_WORD) and word_to_sec_diag_up(letter_grid, i, j + 2, REVERSED_WORD):
                number_of_apperances += 1
